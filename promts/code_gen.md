...
3. Создай структуру директорий и файлов точно так, как указано в разделе «4. Структура проекта» плана (makedir).

4. Сгенерируй код, строго следуя плану:
   ...
   Инструкции по коду:
    - index.html: семантическая вёрстка, подключение стилей и скриптов в порядке, указанном в плане.
...
5. Запиши каждый файл отдельно через write_file, используя пути из структуры проекта.

6. Если план содержит раздел «13. Что нужно уточнить перед началом кода» с неразрешёнными вопросами — остановись и сообщи о необходимости уточнений.

7. После записи всех файлов выведи список созданных артефактов и кратко подтверди, что все пункты плана реализованы.